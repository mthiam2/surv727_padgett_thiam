...
For Twitter data, we used the rtweet package to pull tweets within the specifed timeframe. We also used the tidyverse package through to manipulate the data, pander package   
